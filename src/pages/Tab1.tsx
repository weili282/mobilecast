...
const Tab1: React.FC = () => {
  ...
  useEffect(() => {
      ...
      console.log('home')
    fetch('https://651ru2f8j2.execute-api.us-east-1.amazonaws.com/develop/latestaudio',{
    ...
    fetch('https://651ru2f8j2.execute-api.us-east-1.amazonaws.com/develop/podcastlist',{
      method: 'GET', // *GET, POST, PUT, DELETE, etc.
      mode: 'cors', // no-cors, *cors, same-origin
    cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
    credentials: 'omit',
